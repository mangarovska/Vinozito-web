...
import "./PopUpSave.css"; // Assuming you have a CSS file for styles

const PopUpSave = () => {
  return (
    <div className="popup-overlay">
      <div className="card relative flex flex-col items-center justify-center overflow-clip rounded-[1.5em] bg-[#B7DFFB] shadow-[0px_2px_2px_0px_#1a4766,0px_2px_8px_0px_#3083bb] min-w-[16em] min-h-[10em]">
        <span className="mb-15 text-center text-[1em] font-bold text-[#085991]">
          Зачувај прогрес ?
        </span>
        <div className="group absolute bottom-[-1em] left-[2.5em] flex max-h-[6em] w-[10em] items-center justify-center gap-[10rem]">
